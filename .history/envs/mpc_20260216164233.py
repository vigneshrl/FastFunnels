...
class SEMPCSolver:
    ...
    def _build_problem(self) -> None:
        ...
        for k in range(N + 1):
            ...
            J_contain += 2500.0 * (1.0 + 0.8 * k / N) * ca.fmax(0.0, g_contain) ** 2 #increased the containment penalty weight from 800 --> 2500 
            # ato make containment more stricter without tire model 
